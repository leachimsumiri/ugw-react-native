...
export default class MultiSelect extends Component {
  ...
  _getSelectLabel = () => {
    ...
    //} else if (single) {                             // - HIER - angepasst dass bei Einzelauswahl auch direkt der Text -
    } else if (single || selectedItems.length === 1) { // - HIER - angepasst dass bei Einzelauswahl auch direkt der Text -
      const item = selectedItems[0];
      const foundItem = this._findItem(item);
      //return get(foundItem, displayKey) || selectText;
      const displayText = get(foundItem, displayKey) || selectText;
      return `    ${displayText}`;
    }
    //return `${selectText} (${selectedItems.length} selected)`;   // - HIER - selected Text geändert - HIER -
    //return `${selectText} (${selectedItems.length} ausgewählt)`; // - HIER - selected Text geändert - HIER -
    return "    Filter";
  };
          ...
          >
            ...
            >
              ...
              {/* <TextInput
                ...
                editable = {false} /* - HIER - Suchinput deaktiviert um u.a. Tastatur zu verhindern - HIER - * /
              /> */}
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                  <Icon
                    ...
                    style={[
                      styles.indicator,
                      { paddingLeft: 15, paddingRight: 15 } // HIER: ev paddings anpassen?
                    ]}
                  />
                </TouchableOpacity>
              )}
          ...
          <View>
            ...
            >
              <View
                style={[
                  styles.subSection,
                  // { paddingTop: 10, paddingBottom: 10 }, // HIER: paddings angepasst
